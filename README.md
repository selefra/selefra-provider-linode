# Selefra Provider Linode

Use this repo as a raw reference to **tables and schema** for Linode usage. [Here's](https://github.com/selefra/selefra-provider-linode/blob/main/docs/tables/linode.md) a summary of full coverage. 
